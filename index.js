...
function getLatestProjects(array){
	...
	for (let i in array) {
		let projectPath = array[i].FullPath.replace("/mnt/print2a-volume/repo/print2a/","")
...
let totalProjectFiles = recFilterByExt("/mnt/print2a-volume/repo/print2a", excludeTypes).length;
let totalFiles = recFilterByExt("/mnt/print2a-volume/repo/print2a", /(gitattributes)/i).length;
